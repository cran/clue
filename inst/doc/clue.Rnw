...
\pkg{clue} will add to this list.  E.g., R~2.1.1 added a \code{unique()}
method for lists, making it rather straightforward to provide cluster
ensemble methods for finding unique and duplicated elements, and to
tabulate the elements of the ensemble.
